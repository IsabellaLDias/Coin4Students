...
## 🚀 Deploy
O deploy dos microsserviços é realizado no **Render**, utilizando **Docker**, enquanto o banco de dados PostgreSQL está hospedado no **Supabase**. A mensageria utiliza **CloudAMQP** e os e-mails transacionais utilizam **Brevo**.
